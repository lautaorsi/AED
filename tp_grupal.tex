...
\TLista{\TLista{\float}}, \In pagos: \TLista{\TLista{\float}}, \In eventos: \TLista{\TLista{\nat}}}{}
    ...
    \pred{longitudEventosApuestas}{eventos,apuestas:\TLista{\TLista{\float}}}{(\forall i,j:\ent)(0 \leq i < |eventos| \yLuego 0 \leq j < |eventos[i]|  \implicaLuego eventos[i][j] < |apuestas[i]|)}
...
\begin{proc}{trayectoriaExtrañaEscalera}{\In trayectoria: \TLista{\float}}{\bool}
	...
	CantidadMaximos(Trayectoria) = 1 \lor MaxEnLimite(trayectoria)}
    ...
    \pred{MaxEnLimite}{Trayectoria:\TLista{\float}}{
    ( lista[0] > lista[1]) \lor ( lista[|lista| -1] > lista[|lista| -2])
    }
...
\begin{proc}{individuoActualizaApuesta}{\In individuo: \nat, \In recursos: \TLista{\float}, \In cooperan: \TLista{\bool}, \Inout apuestas: \TLista{\TLista{\float}}, \In pagos: \TLista{\TLista{\float}}, \In eventos: \TLista{\TLista{\nat}}}{}
	\requiere{pagosPositivos(pagos) \land mismaLongitud(recursos,cooperan,apuestas,pagos,eventos) \\ \land apuestasValidas(apuestas) \land longitudApuestasPagos(apuestas,pagos) ^{*} \\ \land longitudEventosApuestas(eventos, apuestas)}
...
*pagosPositivos, mismaLongitud, apuestasValidas, longitudEventosApuestas y longitudApuestasPagos definidos en el ejercicio 1.2
\\
